...
def defence(char_name: str, char_class: str) -> str:
    """Функция, реализующая блокировку."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция, реализующая применение специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция, реализующая выбор персонажа и его действиия
    (аттака, блокировка, суперсила)."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Принимает пользовательский ввод персонажа, описывает его характеристику,
    подтверждает выбор."""
    approve_choice: str = ''
    char_class: str = ''
